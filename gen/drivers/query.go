...
const formattedQueryWarning = "-- This file was generated by bobgen. Please do not edit this file directly.\n\n"
...
func (q QueryFile) Formatted() string {
	...
	sb.WriteString(formattedQueryWarning)
...
func (q QueryFile) QueryPosition(i int) string {
	...
	position := len(formattedQueryWarning) // start at the beginning of the file
