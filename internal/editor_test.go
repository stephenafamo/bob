...
func TestEditor(t *testing.T) {
	tests := map[string]struct {
		...
		"out-of-bounds-delete-start": {
			original: "hello world",
			rules:    []EditRule{Insert(8, "hello"), Delete(7, 10)},
			err:      OutOfBoundsError(7),
		},
		...
		"out-of-bounds-insert-in-deleted": {
			original: "hello world",
			rules:    []EditRule{Delete(5, 10), Insert(6, "beautiful")},
			err:      OutOfBoundsError(6),
		},
	}
