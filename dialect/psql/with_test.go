...
func BenchmarkBaseQueryApplyMutating(b *testing.B) {
...
func BenchmarkBaseQueryWithImmutable(b *testing.B) {
	ctx := context.Background()
...
func BenchmarkViewQueryCountThenPaginateMutating(b *testing.B) {
	ctx := context.Background()
...
func BenchmarkViewQueryCountThenPaginateImmutable(b *testing.B) {
	ctx := context.Background()
